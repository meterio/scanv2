...
new Vue({
  ...
  async mounted() {
    ...
    if (this.network == 'main') {
      ...
      knowns['0x46b77531b74ff31882c4636a35547535818e0baa'] = 'Foundation Growth Reserve Indefinitely Locked';
      ...
      knowns['0x687a6294d0d6d63e751a059bf1ca68e4ae7b13e2'] = 'MTR system contract';
      knowns['0x228ebbee999c6a7ad74a6130e81b12f9fe237ba3'] = 'MTRG system contract';
