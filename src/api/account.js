...
export default {
  ...
  getTransfers(network, address, page, limit = 8) {
    return get(network, `accounts/${address}/transfers?page=${page}&limit=${limit}`);
  },
  ...
  getTxs721(network, address, page, limit = 8) {
    return get(network, `accounts/${address}/erc721txs?page=${page}&limit=${limit}`);
  },
  getTxs1155(network, address, page, limit = 8) {
    return get(network, `accounts/${address}/erc1155txs?page=${page}&limit=${limit}`);
  },
  ...
  getNFTTxs(network, address, page, limit = 8) {
    return get(network, `accounts/${address}/nfttxs?page=${page}&limit=${limit}`);
  },
